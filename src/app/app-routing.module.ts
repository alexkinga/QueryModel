...
@NgModule({
  imports: [RouterModule.forRoot([{ path: 'query-single-user', component: QuerySingleUserComponent }, { path: 'query-single-job', component: QueryArraySingleJobComponent }]), QuerySingleUserComponentModule, UserServiceModule, RoleServiceModule, QueryArraySingleJobComponentModule, JobServiceModule],
